/* Build: assemble-jekyll - v0.3.1 - 2013-07-23 */
/* ===================================================
...
!function(t) {
  ...
  * ====================== */
    ...
    i.prototype.close = function(e) {
        ...
        o || (o = s.attr("href"), o = o && o.replace(/.*(?=#[^\s]*$)/, "")), n = t(o), e && e.preventDefault(), 
        n.length || (n = s.hasClass("alert") ? s : s.parent()), n.trigger(e = t.Event("close")), 
  ...
  * ======================= */
    ...
    }, t.fn.alert.Constructor = i, /* ALERT NO CONFLICT
  * ================= */
...
!function(t) {
  ...
  * ============================== */
    ...
    e.prototype.setState = function(t) {
        ...
        t += "Text", n.resetText || i.data("resetText", i[s]()), i[s](n[t] || this.options[t]), 
  ...
  * ======================== */
    ...
    t.fn.button = function(i) {
        ...
        loadingText: "loading..."
    }, t.fn.button.Constructor = e, /* BUTTON NO CONFLICT
  * ================== */
...
!function(t) {
  ...
  * ========================= */
    var e = function(e, i) {
        ...
        this.options = i, "hover" == this.options.pause && this.$element.on("mouseenter", t.proxy(this.pause, this)).on("mouseleave", t.proxy(this.cycle, this));
    };
    e.prototype = {
        cycle: function(e) {
        ...
        slide: function(e, i) {
            ...
            if (this.sliding = !0, a && this.pause(), o = o.length ? o : this.$element.find(".item")[h](), 
            n = t.Event("slide", {
                relatedTarget: o[0],
                direction: r
            }), !o.hasClass("active")) {
                ...
                this.$element.one("slid", function() {
                    ...
                    o.addClass(e), o[0].offsetWidth, // force reflow
                    s.addClass(r), o.addClass(r), this.$element.one(t.support.transition.end, function() {
  ...
  * ========================== */
    ...
    t.fn.carousel = function(i) {
        ...
        interval: 5e3,
        pause: "hover"
    }, t.fn.carousel.Constructor = e, /* CAROUSEL NO CONFLICT
  * ==================== */
  ...
  * ================= */
    t(document).on("click.carousel.data-api", "[data-slide], [data-slide-to]", function(e) {
        ...
        o.carousel(a), (n = s.attr("data-slide-to")) && o.data("carousel").pause().to(n).cycle(), 
        e.preventDefault();
    });
}(window.jQuery), /* =============================================================
...
!function(t) {
  ...
  * ================================ */
    var e = function(e, i) {
        this.$element = t(e), this.options = t.extend({}, t.fn.collapse.defaults, i), this.options.parent && (this.$parent = t(this.options.parent)), 
    ...
    e.prototype = {
        ...
        show: function() {
            ...
            if (!this.transitioning && !this.$element.hasClass("in")) {
                if (e = this.dimension(), i = t.camelCase([ "scroll", e ].join("-")), n = this.$parent && this.$parent.find("> .accordion-group > .in"), 
                n && n.length) {
        ...
        transition: function(e, i, n) {
            ...
            this.$element.trigger(i), i.isDefaultPrevented() || (this.transitioning = 1, this.$element[e]("in"), 
  ...
  * ========================== */
    ...
    t.fn.collapse = function(i) {
        ...
        toggle: !0
    }, t.fn.collapse.Constructor = e, /* COLLAPSE NO CONFLICT
  * ==================== */
...
!function(t) {
    ...
    function i(e) {
        ...
        return n || (n = e.attr("href"), n = n && /#/.test(n) && n.replace(/.*(?=#[^\s]*$)/, "")), 
        i = n && t(n), i && i.length || (i = e.parent()), i;
    }
    // jshint ;_;
  ...
  * ========================= */
    ...
    s.prototype = {
        ...
        toggle: function() {
            var n, s, o = t(this);
            if (!o.is(".disabled, :disabled")) return n = i(o), s = n.hasClass("open"), e(), 
            s || n.toggleClass("open"), o.focus(), !1;
        },
        keydown: function(e) {
            var s, o, a, r, h;
            if (/(38|40|27)/.test(e.keyCode) && (s = t(this), e.preventDefault(), e.stopPropagation(), 
            !s.is(".disabled, :disabled"))) {
                if (a = i(s), r = a.hasClass("open"), !r || r && 27 == e.keyCode) return 27 == e.which && a.find(n).focus(), 
                s.click();
                o = t("[role=menu] li:not(.divider):visible a", a), o.length && (h = o.index(o.filter(":focus")), 
                38 == e.keyCode && h > 0 && h--, // up
                40 == e.keyCode && o.length - 1 > h && h++, // down
                ~h || (h = 0), o.eq(h).focus());
            }
        }
    };
   ...
   * ========================== */
    ...
    }, t.fn.dropdown.Constructor = s, /* DROPDOWN NO CONFLICT
  * ==================== */
...
!function(t) {
  ...
  * ====================== */
    var e = function(e, i) {
        this.options = i, this.$element = t(e).delegate('[data-dismiss="modal"]', "click.dismiss.modal", t.proxy(this.hide, this)), 
    ...
    e.prototype = {
        ...
        show: function() {
            ...
            this.escape(), this.backdrop(function() {
                ...
                i && e.$element[0].offsetWidth, e.$element.addClass("in").attr("aria-hidden", !1), 
                e.enforceFocus(), i ? e.$element.one(t.support.transition.end, function() {
        ...
        backdrop: function(e) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                n && this.$backdrop[0].offsetWidth, // force reflow
                this.$backdrop.addClass("in"), !e) return;
  ...
  * ======================= */
    ...
    t.fn.modal = function(i) {
        ...
        keyboard: !0,
        show: !0
    }, t.fn.modal.Constructor = e, /* MODAL NO CONFLICT
  * ================= */
  ...
  * ============== */
    t(document).on("click.modal.data-api", '[data-toggle="modal"]', function(e) {
        var i = t(this), n = i.attr("href"), s = t(i.attr("data-target") || n && n.replace(/.*(?=#[^\s]+$)/, "")), o = s.data("modal") ? "toggle" : t.extend({
            remote: !/#/.test(n) && n
        }, s.data(), i.data());
    ...
    var n = t(document.body).on("shown", ".modal", function() {
        n.addClass("modal-open");
...
!function(t) {
  ...
  * =============================== */
    ...
    e.prototype = {
        ...
        init: function(e, i, n) {
            var s, o, a, r, h;
            for (this.type = e, this.$element = t(i), this.options = this.getOptions(n), this.enabled = !0, 
            a = this.options.trigger.split(" "), h = a.length; h--; ) r = a[h], "click" == r ? this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this)) : "manual" != r && (s = "hover" == r ? "mouseenter" : "focus", 
        ...
        enter: function(e) {
            ...
            return this._options && t.each(this._options, function(t, e) {
                n[t] != e && (s[t] = e);
            }, this), i = t(e.currentTarget)[this.type](s).data(this.type), i.options.delay && i.options.delay.show ? (clearTimeout(this.timeout), 
        ...
        leave: function(e) {
            ...
            return this.timeout && clearTimeout(this.timeout), i.options.delay && i.options.delay.hide ? (i.hoverState = "out", 
        ...
        show: function() {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                i = this.getPosition(), n = e[0].offsetWidth, s = e[0].offsetHeight, o) {
                  case "bottom":
                    a = {
                        top: i.top + i.height,
        ...
        applyPlacement: function(t, e) {
            ...
            "top" == e && n != h && (t.top = t.top + h - n, o = !0), "bottom" == e || "top" == e ? (s = 0, 
            0 > t.left && (s = -2 * t.left, t.left = 0, a.offset(t), i = a[0].offsetWidth, n = a[0].offsetHeight), 
        ...
        hide: function() {
            ...
            return this.$element.trigger(n), n.isDefaultPrevented() ? void 0 : (i.removeClass("in"), 
            t.support.transition && this.$tip.hasClass("fade") ? e() : i.detach(), this.$element.trigger("hidden"), 
            this);
        },
        fixTitle: function() {
            var t = this.$element;
  ...
  * =============================== */
    ...
    e.prototype = t.extend({}, t.fn.tooltip.Constructor.prototype, {
        ...
        setContent: function() {
            ...
            t.find(".popover-title")[this.options.html ? "html" : "text"](e), t.find(".popover-content")[this.options.html ? "html" : "text"](i), 
...
!function(t) {
  ...
  * ========================== */
    function e(e, i) {
        ...
        this.options = t.extend({}, t.fn.scrollspy.defaults, i), this.$scrollElement = o.on("scroll.scroll-spy.data-api", s), 
    ...
    e.prototype = {
        ...
        activate: function(e) {
            ...
            i = t(n).parents("li").addClass("active"), i.parent(".dropdown-menu").length && (i = i.closest("li.dropdown").addClass("active")), 
            i.trigger("activate");
        }
    };
...
!function(t) {
  ...
  * ==================== */
    ...
    e.prototype = {
        ...
        show: function() {
            ...
            n = t.Event("show", {
                relatedTarget: e
            }), s.trigger(n), n.isDefaultPrevented() || (i = t(a), this.activate(s.parent("li"), o), 
        ...
        activate: function(e, i, n) {
            function s() {
                ...
                e.addClass("active"), a ? (e[0].offsetWidth, // reflow for transition
                e.addClass("in")) : e.removeClass("fade"), e.parent(".dropdown-menu") && e.closest("li.dropdown").addClass("active"), 
                n && n();
            }
  ...
  * ===================== */
    ...
    }, t.fn.tab.Constructor = e, /* TAB NO CONFLICT
  * =============== */
...
!function(t) {
  ...
  * ================================= */
    var e = function(e, i) {
        this.$element = t(e), this.options = t.extend({}, t.fn.typeahead.defaults, i), this.matcher = this.options.matcher || this.matcher, 
   ...
   * =========================== */
    ...
    t.fn.typeahead = function(i) {
        ...
        item: '<li><a href="#"></a></li>',
        minLength: 1
    }, t.fn.typeahead.Constructor = e, /* TYPEAHEAD NO CONFLICT
  * =================== */
  ...
  * ====================== */
    ...
    e.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            ...
            e = null != this.unpin && n + this.unpin <= s.top ? !1 : null != a && s.top + this.$element.height() >= i - a ? "bottom" : null != r && r >= n ? "top" : !1, 
            this.affixed !== e && (this.affixed = e, this.unpin = "bottom" == e ? s.top - n : null, 
            this.$element.removeClass(h).addClass("affix" + (e ? "-" + e : "")));
        }
    };
